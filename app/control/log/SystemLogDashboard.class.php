...
class SystemLogDashboard extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            $html = new THtmlRenderer('app/resources/adianti/system_log_dashboard.html');
            
            TTransaction::open('log');
            $indicator1 = new THtmlRenderer('app/resources/adianti/info-box.html');
            ...
            $chart1 = new THtmlRenderer('app/resources/adianti/google_column_chart.html');
            $data1 = [];
            ...
            $chart2 = new THtmlRenderer('app/resources/adianti/google_column_chart.html');
            $data2 = [];
            ...
            $chart3 = new THtmlRenderer('app/resources/adianti/google_column_chart.html');
            $data3 = [];
