...
class WelcomeView extends TPage
{
    ...
    function __construct()
    {
        ...
        $html1 = new THtmlRenderer('app/resources/adianti/system_welcome_en.html');
        $html2 = new THtmlRenderer('app/resources/adianti/system_welcome_pt.html');
        $html3 = new THtmlRenderer('app/resources/adianti/system_welcome_es.html');
