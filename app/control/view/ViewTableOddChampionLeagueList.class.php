<?php
/**
 * ViewTableOddChampionLeagueList Listing
 * @author  <your name here>
 */
class ViewTableOddChampionLeagueList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Cotação de cada time da Liga dos Campeões');
