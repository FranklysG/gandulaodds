...
class StateForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->addFields( [ new TLabel('Pais'), $country_id ] );
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new State;  // create an empty object
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['StateList', 'onReload']));
        }
