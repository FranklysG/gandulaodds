 ...
 */
class CountryList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['CountryForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['CountryForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Country
            $repository = new TRepository('Country');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('app'); // open a transaction with database
            $object = new Country($key, FALSE); // instantiates the Active Record
